...
CREATE TABLE `client_inscrit` (
  ...
  `mots_de_passe` varchar(50) DEFAULT NULL,
  `confirmation_mots_de_passe` varchar(50) DEFAULT NULL,
...
(61, 49, 'AUDI', 'AUDI SHAAN', 2000, 'BITE', 17, 12321, '200km/h', 'gogot', 'nini', '2bite', 'kfkgflkjhj', 'https://wordpress-content.vroomly.com/wp-content/uploads/2023/03/koenigsegg.jpg', 'https://wordpress-content.vroomly.com/wp-content/uploads/2023/03/koenigsegg.jpg', 'https://wordpress-content.vroomly.com/wp-content/uploads/2023/03/koenigsegg.jpg', 'https://wordpress-content.vroomly.com/wp-content/uploads/2023/03/koenigsegg.jpg');
...
--
ALTER TABLE `demande_essai`
  MODIFY `id_demande_essai` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `modele`
  MODIFY `id_modele` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;

--
-- AUTO_INCREMENT for table `voitures`
--
ALTER TABLE `voitures`
  MODIFY `id_voiture` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;
